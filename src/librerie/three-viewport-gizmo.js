...
const { Vector3 : M, Vector2 : K, Raycaster : de, Object3D : I, Color : Xt, CanvasTexture : ue, RepeatWrapping : Ot, SRGBColorSpace : he, BufferGeometry : $t, BufferAttribute : at, Sprite : xt, SpriteMaterial : Et, Mesh : X, MeshBasicMaterial : gt, SphereGeometry : Qt, CylinderGeometry : fe, BackSide : pe, InstancedBufferGeometry : me, Float32BufferAttribute : Bt, InstancedInterleavedBuffer : bt, InterleavedBufferAttribute : Z, WireframeGeometry : ge, Box3 : At, Sphere : Yt, ShaderMaterial : ye, ShaderLib : ct, UniformsUtils : Jt, UniformsLib : lt, Vector4 : Q, Line3 : _e, Matrix4 : Kt, MathUtils : ve, Quaternion : J, Clock : be, Scene : we, OrthographicCamera : Se, PerspectiveCamera : xe, Spherical : Ee } = THREE;
const te = (s, e) => {
  const [t, n] = e.split("-");
...
}, Re = (s, e = 2) => s.offset.x = (e ? 0.5 : 0) + s.userData.offsetX, Mt = (s, e) => {
  const {
    offset: t,
